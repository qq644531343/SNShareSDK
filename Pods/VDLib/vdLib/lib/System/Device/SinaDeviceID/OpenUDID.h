...
#define OPEN_UDID_ERROR_NONE        0//kOpenUDIDErrorNone          0
#define OPEN_UDID_ERROR_OPTEDOUT    1//kOpenUDIDErrorOptedOut      1
#define OPEN_UDID_ERROR_COMPROMISED 2//kOpenUDIDErrorCompromised   2
